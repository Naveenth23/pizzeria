...
const specialDeals = async (req, res, next) => {
    try {
        ...
        t1.forEach((element, index, array) => {
            ...
            var myJson = {'id':element.id,'itemName':element.itemName, 'price':element.price, 'extraTopping':element.toppings, 'ingredients':element.newingredients};
            var mydeal = {'id':specialdeals.id,'itemName':specialdeals.itemName, 'price':price};
